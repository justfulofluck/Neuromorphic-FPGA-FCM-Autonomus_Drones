...
This thesis addresses the identified gaps by proposing a \textbf{surrogate-gradient-trained, fixed-point (Q4.11) quantized, FPGA-deployed LIF control network} for autonomous UAV control. The contributions are:
\begin{itemize}
